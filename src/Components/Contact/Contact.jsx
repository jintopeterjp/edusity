...
const Contact = () => {
        ...
        const onSubmit = async (event) => {
          ...
          formData.append("access_key", "25c7ffc4-6dab-4b73-af74-e3fde68ef733");
  ...
  return (
    <div className='contact'>
      <div className="contact-col">
        ...
        <ul>
            <li> <img src={mail_icon} alt="" />jinto.peter3@gmail.com</li>
            <li><img src={phone_icon} alt="" />+91 9497347739</li>
            <li><img src={location_icon} alt="" />Kuttikkatt P. O Arimbur <br />
            680620 Thrissur,Kerala,India</li>
        </ul>
      </div>
      <div className="contact-col">
        <form onSubmit={onSubmit}>
            ...
            'Enter your number' 
            required />
            <label>Write your mesasage</label>
